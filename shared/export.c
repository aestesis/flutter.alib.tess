...
extern void * tessInit(TessBegin *begin, TessDraw *draw, TessEnd *end) {
    ...
    gluTessCallback(tess, GLU_TESS_COMBINE, (GLvoid (*) (void)) &callbackCombine);
    gluTessCallback(tess, GLU_TESS_BEGIN, (GLvoid (*) (void)) begin);
    gluTessCallback(tess, GLU_TESS_VERTEX, (GLvoid (*) (void)) draw);
    gluTessCallback(tess, GLU_TESS_END, (GLvoid (*) (void)) end);
    gluTessCallback(tess, GLU_TESS_ERROR, (GLvoid (*) (void)) callbackError);
    return tess;
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
